...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> ubicacionAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, UbicacionS);
        ubicacionAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        Ubicacion.setAdapter(ubicacionAdapter);
    ...
    public void RegistrarProducto(View view) {
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") &&
                !precio.equals("") && !ubicacion.equals("Seleccione:")) {
    ...
    public void BuscarProducto(View view) {
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this, "Control_Inventario", null, 1);
        SQLiteDatabase BaseDatos = admin.getWritableDatabase();
        String idProducto = ID.getText().toString();
    ...
    public void EliminarProducto(View view) {
        ...
        if (!IDProducto.isEmpty()) {
            ...
            if (Eliminar == 1) {
                ...
                Toast.makeText(this, "No se encontró el producto a eliminar", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(this, "Campo ID no debe estar vacío", Toast.LENGTH_LONG).show();
        }
        BaseDatos.close();
    }
    ...
    public void ModificarProducto(View view) {
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("")
            ...
            if (Update == 1) {
                ...
                Toast.makeText(this, "No se encontró el producto a actualizar", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(this, "No pueden haber campos vacíos", Toast.LENGTH_LONG).show();
        }
        BaseDatos.close();
    }
}
